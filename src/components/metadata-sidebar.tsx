...
${processedContent}`;
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex flex-col sm:flex-row md:flex-col gap-2 pt-2 md:pt-0 md:border-l md:pl-4">
            <Button onClick={handleSuggest} disabled={isGenerating} className="w-full md:w-auto justify-center">
            {isGenerating ? (
            ...
            <Button onClick={handleExport} variant="outline" className="w-full md:w-auto justify-center">
